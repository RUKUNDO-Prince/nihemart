                        ...
                        <div className="w-full">
                          ...
                          <div className="flex justify-between my-2 gap-9">
                            <div className="flex flex-col gap-2 w-[25%]">
                              <label>Name</label>
                              <input type="text" placeholder="Attribute's name" className="font-poppins font-medium text-[15px] bg-gray-90 bg-opacity-[40%] p-2 h-10 rounded-md outline-none" />
                            </div>
                            <div className="flex flex-col gap-2 w-[70%]">
                              <label>Values</label>
                              <input type="text" placeholder="Attribute's values, they should be separated by comma (,)" className="font-poppins font-medium text-[15px] bg-gray-90 bg-opacity-[40%] p-2 h-10 rounded-md outline-none" />
                            </div>
                          </div>
                          <ErrorMessage
                            name="gender"
