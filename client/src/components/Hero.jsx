        ...
        <div className="flex justify-between items-start">
          <div className="w-[40%]">
            <div className="flex gap-5 items-center justify-start mb-4">
              ...
              <h1 className="text-white font-semibold text-[1.1em]">{item.name}</h1>
            </div>
            <p className="text-white text-[4em]/[65px] font-semibold ">{item.heading}</p>
            <a href="/" className="text-white link">Shop now</a>
          </div>
          <div>
