            ...
            {productDetails?.length > 0 &&
              productDetails?.map((product, idx) => (
                <div
                  ...
                  key={idx}
                >
                  <h2 className="text-black font-bold flex items-center justify-between border-b pb-1 p-2">
                    product name:{" "}
                    <span className="font-normal">{product.name}</span>
                  </h2>
                  <h2 className="text-black font-bold flex items-center justify-between border-b pb-1 p-2">
                    product unit price:{" "}
                    <span className="font-normal">{displayNumbers(product.price)}</span>
                  </h2>
                  <h2 className="text-black font-bold flex items-center justify-between border-b pb-1 p-2">
                    quantity:{" "}
                    <span className="font-normal">{product.quantity}</span>
                  </h2>
                  <h2 className="text-black font-bold flex items-center justify-between border-b p-2">
                    Ayo urishyura:{" "}
                    <span className="font-normal">
                      {displayNumbers(product.price * product.quantity)} Frw
                    </span>
                  </h2>
                  <h2 className="text-black font-bold flex items-center justify-between p-2">
                    Ayo kubikugezaho:{" "}
                    <span className="font-normal">
                      1,000 Frw
                    </span>
